...
from app.utils.parse_config import get_default_memory_config, _parse_environment_variables
...
def reset_memory_client():
    ...
    global _memory_client, _config_hash, _memory_config
    _memory_client = None
    _config_hash = None
    _memory_config = None


def get_memory_config(custom_instructions: str = None):
...
def get_memory_client(custom_instructions: str = None):
    ...
    try:
        config = get_memory_config(custom_instructions)
